...
const plans = [
    ...
    },
    {
        ...
        period: '/mês',
        popular: true,
        features: ['Documentos ilimitados', 'Até 10 usuários', 'Automações avançadas', 'Suporte prioritário'],
    },
    {
        id: 'enterprise',
        name: 'Enterprise',
        price: 'R$ 899',
        period: '/mês',
        features: ['Recursos completos', 'Usuários ilimitados', 'Integrações personalizadas', 'Gerente dedicado'],
    },
];

const StepSelecaoPlanoEmpresa = ({ formData, onChange }) => {
        ...
        <div className={styles.container}>
            <div className={styles.header}>
                ...
                <div>
                    ...
                    <p className={styles.subtitle}>Escolha o plano ideal para seu negócio</p>
                </div>
            </div>
...
export default StepSelecaoPlanoEmpresa;